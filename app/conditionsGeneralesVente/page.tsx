  ...
  return (
    <div className="CGV">
      <div className="container">
        ...
        {/* Sommaire cliquable */}
        <nav className="CGV_toc" style={{margin: '2rem 0'}}>
          <h2>Sommaire</h2>
          <ul style={{listStyle: 'none', paddingLeft: 0}}>
            <li><a href="#article1">Article 1 – Définitions</a></li>
            <li><a href="#article2">Article 2 – Objet</a></li>
            <li><a href="#article3">Article 3 – Conditions générales d'exécution</a></li>
            <li><a href="#article4">Article 4 – Obligations du Prestataire</a></li>
            <li><a href="#article5">Article 5 – Obligations du Client</a></li>
            <li><a href="#article6">Article 6 – Prix et conditions de paiement</a></li>
            <li><a href="#article7">Article 7 – Contrat de maintenance : Matériel ou logiciel</a></li>
            <li><a href="#article7-1">Article 7-1 – Durée des contrats de maintenance ou abonnement</a></li>
            <li><a href="#article7-2">Article 7-2 – Révision des prix</a></li>
            <li><a href="#article7-3">Article 7-3 – Exclusions des contrats de maintenance</a></li>
            <li><a href="#article8">Article 8 – Logiciel</a></li>
            <li><a href="#article8-1">Article 8-1 – Contrat de maintenance EBP</a></li>
            <li><a href="#article8-2">Article 8-2 – Exclusion</a></li>
            <li><a href="#article8-3">Article 8-3 – Accès au(x) logiciel(s)</a></li>
            <li><a href="#article8-4">Article 8-4 – Obligation du client</a></li>
            <li><a href="#article8-5">Article 8-5 – Limitations de Responsabilité Logiciels d'entreprise EBP</a></li>
            <li><a href="#article9">Article 9 – Conditions particulières</a></li>
            <li><a href="#article10">Article 10 – Pénalités</a></li>
            <li><a href="#article11">Article 11 – Conditions d'exécution propres à la commande et à la vente de matériels</a></li>
            <li><a href="#article12">Article 12 – Loi informatique et libertés</a></li>
            <li><a href="#article13">Article 13 – Territoire</a></li>
            <li><a href="#article14">Article 14 – Nullité</a></li>
            <li><a href="#article15">Article 15 – Loi applicable</a></li>
            <li><a href="#article16">Article 16 – Tribunaux compétents et règlements des différends</a></li>
            <li><a href="#article17">Article 17 – Règlement des litiges</a></li>
          </ul>
        </nav>
        <div className="CGV_container">
          ...
          <p>
            Le <span>Client</span><br />
            ET<br />
            <span>Société Solution Logique</span><br />
            Sarl au capital social de 15 000 Euros,<br />
            Immatriculée au Registre du Commerce et des Sociétés d'Annecy sous le numéro 379 868 540<br />
            Dont le siège social est situé 475 route des Vernes 74370 Pringy<br />
            Ci-après nommé le <span>Prestataire Solution Logique</span>,
          </p>
        </div>
        <div className="CGV_container">
          <h3>ETANT PREALABLEMENT EXPOSE QUE :</h3>
          <p>La société <span>Solution logique</span> est une société de prestations de services informatiques divers tels que, notamment, dépannage, installation de logiciels et de matériels, assistance, formation, maintenance… et ce auprès des entreprises, professions libérales, administrations.</p>
          <p>La société <span>Solution logique</span> réalise de la vente de produits informatiques (ordinateur, imprimante, logiciels…) sur commande.</p>
          <p>L'offre de prestations de service de la société <span>Solution logique</span> se décline comme suit :</p>
          <ul>
            <li>l'installation et ou l'intervention (service à la carte ou décompte d'heures)</li>
        ...
        <div className="CGV_container">
          <h4 id="article1">Article 1 – Définitions</h4>
          <p>Par Conditions générales de Vente et de Services, on entend désigner le présent acte.</p>
          <p>Par Parties, on entend désigner le Client et Solution logique.</p>
          <p>Par Matériels, on entend désigner les marchandises commandées et livrées par Solution logique au Client.</p>
          <p>Par Prestation, on entend désigner toute intervention de Solution logique au domicile du Client ou en ses locaux professionnels.</p>
          <p>Par Installation ou Intervention, on entend désigner une intervention de Solution logique au domicile ou dans les locaux professionnels du Client afin de dépanner un ordinateur, une imprimante, un périphérique, Internet, un réseau…, installer un nouveau matériel ou logiciel, éradiquer un virus… et ce de façon ponctuelle (« service à la carte ») ou dans le cadre de l'achat d'un « Contrat en temps partagé » CTP.</p>
          <p>Par le Contrat en temps partagé, on entend désigner un nombre d'heures de services de Solution logique acheté par le Client pour les besoins informatiques de ce dernier. Ce crédit d'intervention est géré par le Client à sa convenance et peut être utilisé pour toute opération logicielle ou matérielle, pour toute formation informatique, pour tout autre type d'assistance informatique.</p>
          <p>Par Vente de matériels, on entend désigner la commande et la livraison de matériels tels que logiciel, serveur, ordinateur, imprimante, firewall … par Solution logique au Client.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article2">Article 2 – Objet</h4>
        ...
        <div className="CGV_container">
          <h4 id="article3">Article 3 – Conditions générales d'exécution</h4>
        ...
        <div className="CGV_container">
          <h4 id="article4">Article 4 – Obligations du Prestataire</h4>
          ...
          <p>Exonération de responsabilité : le Client est informé que la réalisation des Prestations entraîne une rupture de la garantie du constructeur et/ou du distributeur auprès duquel le Client a acquis ses équipements et à laquelle ne se substitue en aucun cas une garantie de Solution logique.</p>
          <p>De convention expresse entre les parties, Solution logique n'est soumis, au titre des présentes qu'à une obligation de moyen et en aucun cas à une obligation de résultats. Solution logique intervient uniquement sur demande expresse du Client, aussi en aucun cas Solution logique ne peut être tenu responsable des dommages directs et/ou indirects, matériels ou immatériels.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article5">Article 5 – Obligations du Client</h4>
        ...
        <div className="CGV_container">
          <h4 id="article6">Article 6 – Prix et conditions de paiement :</h4>
          ...
          <p>Sauf dispositions contraires figurant sur la facture ou sur la fiche d'ouverture de compte remplie et signée par le Client, le délai de paiement des sommes dues est fixé au maximum le trentième jour suivant la date de réception des marchandises ou d'exécution de la prestation demandée (c. com. Art. L.441-6).</p>
          ...
          <p>Dans le cas de règlements échelonnés, concrétisés ou non par des traites, le non-paiement d'une seule échéance rendra immédiatement exigible la totalité du solde restant dû, sans qu'il soit besoin d'une mise en demeure et sans préjudice de tous autres droits.</p>
        ...
        <div className="CGV_container">
          ...
          <p>Solution Logique, ne prends également pas en charge toutes erreurs ou mauvaises manipulations de l'utilisateur.</p>
          <p>Cependant ces prestations pourront être effectuées par Solution Logique, un bon de commande devra être validé et accepté par le client.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article8">Article 8 – Logiciel</h4>
          <p>Objet : Le bon fonctionnement du matériel et des programmes sont garanties pour la durée mentionnée sur le(s) dit(s) contrat(s) signé(s) par le client. Cette garantie couvre les vices cachés de construction pendant un an et les défauts de matière, mais ne couvre pas les « bugs » des éditeurs de logiciels. Toute pièce défectueuse sera remplacée si elle est couverte par une garantie constructeur et validé par un contrat de maintenance matériel en cours de validité indiquant clairement son changement, ce dit contrat de maintenance doit être obligatoirement contracté par le client auprès de Solution Logique étant précisé sous réserve que I 'ensemble des factures émises aient été réglées à la date de(s) échéance(s) indiquée(s).</p>
          <p>En cas de résiliation par anticipation d'un ou des contrats de maintenance matériel, logiciel ou prestation souscrit par le client ce dernier s'engage à indemniser Solution Logique en partie à titre de dédommagement du préjudice sur les prévisions d'embauche du personnel technique, ou administratif que Solution Logique engage afin d'assurer ces contrats ou prestation de maintenance matériel ou logiciel. Dans tous les cas de résiliation survenant avant l'expiration du ou des contrats matériel ou logiciel, le client procédera au paiement à Solution Logique d'une indemnité égale à la totalité des montants dus ou à devoir jusqu'à la date d'expiration de la période contracté jusqu'à un maximum de cinq ans.</p>
          <p>Pour les contrats spécifiques de temps partagé (CTP) ou de contrats de maintenance 'pack cartouche' ou contrat ne prenant en compte que la prestation de maintenance hors pièces détachées, devront être payé en totalité en cas de résiliation par anticipation et ce jusqu'à l'expiration des dits contrats pour un maximum de cinq ans. Le calcul prise en compte que le client accepte se fera sur la base des heures déjà effectuées et ou des consommables utilisés des périodes précédentes, la moyenne sera prise en compte et multiplié par la durée restante à échoir jusqu'à un maximum de cinq ans. Cependant un montant minimum de 895 € HT par an sera facture.</p>
          <p>Les fournitures consommables (encre, ruban, papier, disque dur externe et autres) ne font pas l'objet du présent contrat. Le technicien interviendra pendant les heures ouvrables des jours ouvrés du service de maintenance désigné. Le bénéficiaire de la garantie ne pourra prétendre à aucune indemnité pour privation de jouissance qu'elle qu'en soit la cause. Les conditions générales sont établies pour des appareils dont l'utilisation journalière ne dépasse pas l'horaire légal d'un utilisateur. Ne font pas l'objet de la garantie, les pannes dues aux négligences, aux défauts d'utilisation ou de surveillance, d'entretien ainsi que les dépannages de programmes dus aux coupures de courant si le matériel n'est pas équipé d'un onduleur, si les sauvegardes ne sont pas faîtes, et de façon générale, toute utilisation non conforme aux prescriptions ou spécifications précisées dans le manuel des constructeurs. Pour les réparations importantes, hors garantie et hors contrat, un devis sera préalablement validé sur demande expresse du client et signé par le client. Le vendeur est déchargé de toute responsabilité en cas de suspension ou d'inexécution de son obligation de service imputable à un évènement indépendant de sa volonté (grève, incendie, etc...) l'empêchant de s'exécuter. L'appréciation de la périodicité des visites et la nécessité du remplacement des pièces sont laissées à l'initiative du vendeur. Le déplacement d'un appareil sera subordonné à son accord, le non-respect de cette clause pourra entraîner la résiliation de plein droit du contrat par ce dernier, tous les frais consécutifs à ce déplacement resteront à la charge du client. Tout déplacement non-pré facturé (ou non couvert par le contrat) sera facturé, en sus, au tarif en vigueur. Ledit contrat de maintenance ne peut être cédé avec la vente du matériel à un tiers ; dans ce cas, les obligations du vendeur cesseront de plein droit sans qu'il lui soit fait obligation de rembourser tout ou partie des sommes versées. En cas d'absence de document dument signé par le client depuis un an, la présente facture tient lieu de contrat et prend en compte les conditions inscrites dans l'article 7, que le client accepte dans son intégralité et sans réserve.</p>
        ...
        <div className="CGV_container">
          <h4 id="article8-1">Article 8-1 – Contrat de maintenance EBP</h4>
          <p>Objet : Le bon fonctionnement du matériel et des programmes sont garanties pour la durée mentionnée sur le(s) dit(s) contrat(s) signé(s) par le client. Cette garantie couvre les vices cachés de construction pendant un an et les défauts de matière, mais ne couvre pas les « bugs » des éditeurs de logiciels. Toute pièce défectueuse sera remplacée si elle est couverte par une garantie constructeur et validé par un contrat de maintenance matériel en cours de validité indiquant clairement son changement, ce dit contrat de maintenance doit être obligatoirement contracté par le client auprès de Solution Logique étant précisé sous réserve que I 'ensemble des factures émises aient été réglées à la date de(s) échéance(s) indiquée(s).</p>
          <p>En cas de résiliation par anticipation d'un ou des contrats de maintenance matériel, logiciel ou prestation souscrit par le client ce dernier s'engage à indemniser Solution Logique en partie à titre de dédommagement du préjudice sur les prévisions d'embauche du personnel technique, ou administratif que Solution Logique engage afin d'assurer ces contrats ou prestation de maintenance matériel ou logiciel. Dans tous les cas de résiliation survenant avant l'expiration du ou des contrats matériel ou logiciel, le client procédera au paiement à Solution Logique d'une indemnité égale à la totalité des montants dus ou à devoir jusqu'à la date d'expiration de la période contracté jusqu'à un maximum de cinq ans.</p>
          <p>Pour les contrats spécifiques de temps partagé (CTP) ou de contrats de maintenance 'pack cartouche' ou contrat ne prenant en compte que la prestation de maintenance hors pièces détachées, devront être payé en totalité en cas de résiliation par anticipation et ce jusqu'à l'expiration des dits contrats pour un maximum de cinq ans. Le calcul prise en compte que le client accepte se fera sur la base des heures déjà effectuées et ou des consommables utilisés des périodes précédentes, la moyenne sera prise en compte et multiplié par la durée restante à échoir jusqu'à un maximum de cinq ans. Cependant un montant minimum de 895 € HT par an sera facture.</p>
          <p>Les fournitures consommables (encre, ruban, papier, disque dur externe et autres) ne font pas l'objet du présent contrat. Le technicien interviendra pendant les heures ouvrables des jours ouvrés du service de maintenance désigné. Le bénéficiaire de la garantie ne pourra prétendre à aucune indemnité pour privation de jouissance qu'elle qu'en soit la cause. Les conditions générales sont établies pour des appareils dont l'utilisation journalière ne dépasse pas l'horaire légal d'un utilisateur. Ne font pas l'objet de la garantie, les pannes dues aux négligences, aux défauts d'utilisation ou de surveillance, d'entretien ainsi que les dépannages de programmes dus aux coupures de courant si le matériel n'est pas équipé d'un onduleur, si les sauvegardes ne sont pas faîtes, et de façon générale, toute utilisation non conforme aux prescriptions ou spécifications précisées dans le manuel des constructeurs. Pour les réparations importantes, hors garantie et hors contrat, un devis sera préalablement validé sur demande expresse du client et signé par le client. Le vendeur est déchargé de toute responsabilité en cas de suspension ou d'inexécution de son obligation de service imputable à un évènement indépendant de sa volonté (grève, incendie, etc...) l'empêchant de s'exécuter. L'appréciation de la périodicité des visites et la nécessité du remplacement des pièces sont laissées à l'initiative du vendeur. Le déplacement d'un appareil sera subordonné à son accord, le non-respect de cette clause pourra entraîner la résiliation de plein droit du contrat par ce dernier, tous les frais consécutifs à ce déplacement resteront à la charge du client. Tout déplacement non-pré facturé (ou non couvert par le contrat) sera facturé, en sus, au tarif en vigueur. Ledit contrat de maintenance ne peut être cédé avec la vente du matériel à un tiers ; dans ce cas, les obligations du vendeur cesseront de plein droit sans qu'il lui soit fait obligation de rembourser tout ou partie des sommes versées. En cas d'absence de document dument signé par le client depuis un an, la présente facture tient lieu de contrat et prend en compte les conditions inscrites dans l'article 7, que le client accepte dans son intégralité et sans réserve.</p>
        ...
        <div className="CGV_container">
          <h4 id="article8-2">Article 8-2 – Exclusion</h4>
          <p>Les virus et tous les problèmes qui en découlent, ainsi que tout piratage informatique ou risque cyber, ne sont pas couverts par le(s) contrat(s) de maintenance matérielle ou logiciels. Cette exclusion s'applique même si le client est équipé de pare-feu, d'antispam ou de tout autre matériel et logiciel disponible sur le marché.</p>
          <p>Solution Logique, ne prends également pas en charge toutes erreurs ou mauvaises manipulations de l'utilisateur.</p>
          <p>Cependant ces prestations pourront être effectuées par Solution Logique, un bon de commande devra être validé et accepté par le client.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article8-3">Article 8-3 – Accès au(x) logiciel(s)</h4>
          <p>Solution Logique, ne prends également pas en charge toutes erreurs ou mauvaises manipulations de l'utilisateur.</p>
          <p>Cependant ces prestations pourront être effectuées par Solution Logique, un bon de commande devra être validé et accepté par le client.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article8-4">Article 8-4 – Obligation du client</h4>
          <p>Le Client s'engage à informer au mieux Solution logique en cas de panne afin que l'intervention de dépannage puisse avoir lieu le plus rapidement possible et le plus efficacement possible.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article8-5">Article 8-5 – Limitations de Responsabilité Logiciels d'entreprise EBP</h4>
          <p>Solution Logique, ne prends également pas en charge toutes erreurs ou mauvaises manipulations de l'utilisateur.</p>
          <p>Cependant ces prestations pourront être effectuées par Solution Logique, un bon de commande devra être validé et accepté par le client.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article9">Article 9 – Conditions particulières</h4>
          <p>Le Client s'engage à respecter les procédures d'utilisation des équipements (logiciels, accessoires, périphériques, consommables...) et en particulier à ne pas procéder à des modifications techniques. Le Client s'engage à déplacer ou à nettoyer tout élément considéré d'un avis raisonnable par l'intervenant comme gênant pour assurer les Prestations.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article10">Article 10 – Pénalités</h4>
          <p>Le Client s'engage à respecter les procédures d'utilisation des équipements (logiciels, accessoires, périphériques, consommables...) et en particulier à ne pas procéder à des modifications techniques. Le Client s'engage à déplacer ou à nettoyer tout élément considéré d'un avis raisonnable par l'intervenant comme gênant pour assurer les Prestations.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article11">Article 11 – Conditions d'exécution propres à la commande et à la vente de matériels</h4>
          <p>Le Client s'engage à respecter les procédures d'utilisation des équipements (logiciels, accessoires, périphériques, consommables...) et en particulier à ne pas procéder à des modifications techniques. Le Client s'engage à déplacer ou à nettoyer tout élément considéré d'un avis raisonnable par l'intervenant comme gênant pour assurer les Prestations.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article12">Article 12 – Loi informatique et libertés</h4>
          <p>Le Client s'engage à respecter les procédures d'utilisation des équipements (logiciels, accessoires, périphériques, consommables...) et en particulier à ne pas procéder à des modifications techniques. Le Client s'engage à déplacer ou à nettoyer tout élément considéré d'un avis raisonnable par l'intervenant comme gênant pour assurer les Prestations.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article13">Article 13 – Territoire</h4>
          <p>Le Client s'engage à respecter les procédures d'utilisation des équipements (logiciels, accessoires, périphériques, consommables...) et en particulier à ne pas procéder à des modifications techniques. Le Client s'engage à déplacer ou à nettoyer tout élément considéré d'un avis raisonnable par l'intervenant comme gênant pour assurer les Prestations.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article14">Article 14 – Nullité</h4>
          <p>Le Client s'engage à respecter les procédures d'utilisation des équipements (logiciels, accessoires, périphériques, consommables...) et en particulier à ne pas procéder à des modifications techniques. Le Client s'engage à déplacer ou à nettoyer tout élément considéré d'un avis raisonnable par l'intervenant comme gênant pour assurer les Prestations.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article15">Article 15 – Loi applicable</h4>
          <p>Le Client s'engage à respecter les procédures d'utilisation des équipements (logiciels, accessoires, périphériques, consommables...) et en particulier à ne pas procéder à des modifications techniques. Le Client s'engage à déplacer ou à nettoyer tout élément considéré d'un avis raisonnable par l'intervenant comme gênant pour assurer les Prestations.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article16">Article 16 – Tribunaux compétents et règlements des différends</h4>
          <p>Le Client s'engage à respecter les procédures d'utilisation des équipements (logiciels, accessoires, périphériques, consommables...) et en particulier à ne pas procéder à des modifications techniques. Le Client s'engage à déplacer ou à nettoyer tout élément considéré d'un avis raisonnable par l'intervenant comme gênant pour assurer les Prestations.</p>
        </div>
        <div className="CGV_container">
          <h4 id="article17">Article 17 – Règlement des litiges</h4>
          <p>Le Client s'engage à respecter les procédures d'utilisation des équipements (logiciels, accessoires, périphériques, consommables...) et en particulier à ne pas procéder à des modifications techniques. Le Client s'engage à déplacer ou à nettoyer tout élément considéré d'un avis raisonnable par l'intervenant comme gênant pour assurer les Prestations.</p>
        </div>
      </div>
    </div>
